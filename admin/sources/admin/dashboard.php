	...
	<div class="col-lg-3">
		<div class="panel panel-default facebook-like">
                    <div class="panel-body fa-icons">
                        ...
                        <i class="fa fa-bitcoin" style="font-size: 40px;" ></i>
                    </div>
                </div>
	</div>
	<div class="col-lg-3">
												...
												<div class="col-md-10">
													<table class="table table-striped">
														<tbody>
															<tr>
																<td>User:</td>
																<td><a target="_blank" href="./?a=transactions&b=by_user&uid=<?php echo $row['uid']; ?>"><?php echo idinfo($row['uid'],"username"); ?></a></td>
															</tr>
															<tr>
																<td>Transaction:</td>
																<td><a target="_blank" href="https://chain.so/tx/BTCTEST/<?php echo $row['txid']; ?>"><?php echo $row['txid']; ?></a></td>
															</tr>	
															<tr>
																<td>Sender:</td>
